 ...
 */
public class MyAdapterListasRecycleView extends RecyclerView.Adapter<MyAdapterListasRecycleView.ViewHolder> {
    ...
    public MyAdapterListasRecycleView(Context context,  List<GuestModel> guestModels) {
